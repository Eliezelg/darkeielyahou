      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <section className="mt-16">
          ...
          <div className="bg-muted p-6 rounded-lg mb-8">
            <p className="mb-4">
              Pour postuler au Kollel Daf Hayomi, veuillez nous contacter directement via notre formulaire de contact.
            </p>
            <p className="mb-4 font-medium">Informations à préparer pour votre demande :</p>
            <ul className="list-disc pl-5 space-y-1 mb-6">
              <li>Précisez que vous êtes intéressé par le Kollel Daf Hayomi</li>
