// Service d'envoi d'emails via l'API backend
...
// Email par défaut - doit être vérifié dans SendGrid
const DEFAULT_EMAIL = process.env.NEXT_PUBLIC_SENDGRID_FROM_EMAIL || 'contact@darkei-elyahou.org';
...
/**
 * Formatage des données du formulaire pour SendGrid
 */
